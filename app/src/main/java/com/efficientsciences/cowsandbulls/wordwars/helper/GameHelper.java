...
import com.efficientsciences.cowsandbulls.wordwars.LoginSign;
...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    public static final  int RC_SIGN_IN = 1642;
...
// basic profile are included in DEFAULT_SIGN_IN.
    ...
    public void onActivityResult(int requestCode, int responseCode, Intent data) {
        ...
        if (requestCode != RC_RESOLVE && requestCode != LoginSign.PICK_ACCOUNT_REQUEST) {
        ...
        if (responseCode == Activity.RESULT_OK) {
            ...
            debugLog("onAR: responseCode="
                    ...
                    + ", so giving up.");
            giveUp(new SignInFailureReason(null != mConnectionResult ? 0 : mConnectionResult.getErrorCode(),
                    responseCode));
        }
    }
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if (connectionHint != null) {
            ...
            if (ContextCompat.checkSelfPermission(ResourcesManager.getInstance().activity, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(ResourcesManager.getInstance().activity, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
