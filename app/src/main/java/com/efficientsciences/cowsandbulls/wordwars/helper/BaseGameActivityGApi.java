...
import com.google.android.gms.common.api.GoogleApiClient;
     ...
     */
    public abstract class BaseGameActivityGApi extends FragmentActivity implements
        ...
        protected BaseGameActivityGApi() {
            super();
        }
         ...
         *         CLIENT_PLUS).
         */
        protected BaseGameActivityGApi(int requestedClients) {
            super();
