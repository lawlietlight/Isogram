...
public class Message {
	...
	public boolean equals(Object o) {
		...
		if(o instanceof Message && null!=this.getMessage()){
			return this.getMessage().equalsIgnoreCase(" \n<b>"+StorageManager.getInstance().getUser().getDisplayName()+":</b> "+((Message)o).getMessage()) && isMine;
		}
		return false;
	}
