               ...
               if (msgType == WampMessage.MESSAGE_TYPE_CALL_RESULT) {
                  ...
                  if (mSubs.containsKey(topicUri)) {
                     ...
                     notify(new WampMessage.Event(topicUri, event));
                	  ...
                	  boolean _flag = false;
                	  for (String b : mSubs.keySet()) {

                		  if(b.contains("#usereventword")){
                			  _flag = false;
                			  break;
                		  }
                		  else{
                				  ...
                				  Log.d(TAG, "Something went wrong in subscription");
                				  //TODO  Somehow get the topiURI and call meta into mSub or check the place where subscription gets reset/cleared/removed
                	  ...
                	  if (_flag && DEBUG) Log.d(TAG, "WAMP event for not-subscribed topic received");
