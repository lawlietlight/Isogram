...
public interface Wamp {
    ...
    */
   public void connect(String wsUri, ConnectionHandler sessionHandler, List<ContentValues> headers);
    ...
    */
   public void connect(String wsUri, ConnectionHandler sessionHandler, WampOptions options, List<ContentValues> headers);
    ...
    * Check if currently connected to server.
    *
    *     fail, if pong response not received successively.
    */
