...
public class WampConnection extends WebSocketConnection implements Wamp {
   ...
   public final ConcurrentHashMap<String, CallMeta> mCalls = new ConcurrentHashMap<String, CallMeta>();
   ...
   public final ConcurrentHashMap<String, SubMeta> mSubs = new ConcurrentHashMap<String, SubMeta>();
   ...
   public void connect(String wsUri, Wamp.ConnectionHandler sessionHandler) {
      ...
      /*options.setSocketConnectTimeout(30);
    ...
    */
   public void connect(String wsUri, Wamp.ConnectionHandler sessionHandler, WampOptions options, List<ContentValues> headers) {
   ...
   //Sathish Modified
   public void connect(String wsUri, Wamp.ConnectionHandler sessionHandler, List<ContentValues> headers) {
...
/* (non-Javadoc)
 * @see de.tavendo.autobahn.Wamp#failConnection(java.lang.String, java.lang.String)
 */
public void failConnection(String reasonSource, String reason) {
